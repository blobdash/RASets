...
class MegamindRichPresence(RichPresence):
    ...
    def generate(self):
        ...
        self.add_lookup('MenuScene', {
            (0x0, 0x01, 0x02, 0x03, 0xffffffff): 'Loading...',
        ...
        self.add_display(
                ...
                ((ptr(Memory.MENU_STATE.address) >> ptr(0xac) >> ptr(0x140) >> dword(0xf4) <= 0x0c) |
                (ptr(Memory.MENU_STATE.address) >> ptr(0xac) >> ptr(0x140) >> dword(0xf4) == 0xffffffff)), 
            f'{self.getMenuScene()}'
        )
    ...
    def getMenuScene(self):
        return f'@MenuScene({(ptr(Memory.MENU_STATE.address) >> ptr(0xac) >> ptr(0x140) >> measured(dword(0xf4)))})'
